              ...
              <div class="card info-card">
                <div class="card-body">
                  ...
                  <div class="card-body">
                    ...
                    <?php
                    $query = "SELECT * FROM privilages WHERE uid = $id";
...
if (isset($_POST['saveuser'])) {
  ...
  if (isset($_POST['privilege'])) {
    ...
    $existing_privileges_query = "SELECT * FROM privilages WHERE uid = $id";
    ...
    foreach ($privileges as $privilege) {
      ...
      if (in_array($privilege, $existing_privileges)) {
        ...
        $remove_query = "DELETE FROM privilages WHERE uid = $id AND title = '$privilege'";
        mysqli_query($connection, $remove_query);
      } else {
        // If privilege doesn't exist, save it
        $save_query = "INSERT INTO privilages (uid, title) VALUES ($id, '$privilege')";
