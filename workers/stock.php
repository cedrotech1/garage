  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        $query = "SELECT p.pid, p.*, s.quantity AS product_quantity,s.unit_cost AS unit_cost ,s.total_cost AS total_cost  FROM `product` AS p LEFT JOIN `stock` AS s ON p.pid = s.pid where p.pid=$idi";
      ...
      <div class="tab-pane fade show active" id="home-justified" role="tabpanel" aria-labelledby="home-tab">
        <div class="row">
          <div class="col-md-6">
            ...
            <input type="text" name='pid' value='<?php echo $idi ?>' hidden>
              ...
              <div class="tab-content pt-2" id="borderedTabJustifiedContentHome">
                ...
                <div class="tab-pane fade" id="date" role="tabpanel" aria-labelledby="date-tab">
                  <div class="mb-3 form-floating">
                    <input type="date" class="form-control" id="record_date" name='record_date' disabled>
